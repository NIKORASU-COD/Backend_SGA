...
public class CategoriaController {
    ...
    @GetMapping("Consultar/{id_categoria}")
    public ResponseEntity<CategoriaDto>buscarId(@PathVariable Integer id_categoria){
    CategoriaDto categoriaDto2 = cs.getCategoria(id_categoria);
    return ResponseEntity.ok(categoriaDto2);
    }
